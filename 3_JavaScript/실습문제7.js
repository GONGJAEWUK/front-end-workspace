const section1 = document.querySelectorAll(".section1 img");
...
function clickHandler() {
  ...
  for (let i = 0; i < section1.length; i++) {
    section1[i].setAttribute("src", `../resources/family${random[i]}.jpg`);
  }
  // 내가 클릭한 만큼 숫자가 증가
...
function restartHandler() {
  ...
  for (let i = 0; i < section1.length; i++) {
    section1[i].setAttribute("src", `../resources/family${i + 1}.jpg`);
  }
